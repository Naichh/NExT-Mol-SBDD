...
# --- 2. 数据存储目录 ---
CKPT_PATH="/data/share/liuzhiyuan/nai/NExT-Mol/all_checkpoints/stage1/fft/sbdd_full-finetune_20251001_141104/epoch=11.ckpt"
...
torchrun --nproc_per_node=4 --master_port=55357  llm_train_cross_docked.py \
